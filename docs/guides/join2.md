...
[查看领地操作文档](https://dominion.lunadeer.cn/notes/doc/player/){ .md-button .md-button--primary target="_blank" }
...
## 超远视距
### 注意
超远视距功能需安装配套客户端Mod，点击下方按钮下载：

[下载超远视距Mod](https://modrinth.com/mod/distanthorizons#download){ .md-button .md-button--primary target="_blank" }

（注：已适配1.21.8版本，推荐客户端版本使用）

### 模组简介
基于 Level of Detail (LOD) 技术的性能优化模组，通过以下方式提升游戏体验：
- 动态简化地形：远处方块自动合并为低模模型，显著降低GPU负载
- 超远视距：突破原版视距限制，轻松眺望数万格外的山脉与建筑
- 帧率优化：即使在大型世界中，也能保持稳定FPS

### 功能演示图
![超远视距效果演示](https://i.postimg.cc/76xGfwPG/1718015861-782037-hf-Jm.webp)

### 服务器支持说明
- 已适配版本：1.21.8（推荐客户端版本）
- 自动同步地形数据，无需额外配置文件
- 禁用冲突模组以确保兼容性
...
### 注意事项
- 材质包兼容性：部分高清材质（如Sphax）可能与LOD冲突，建议使用默认材质或适配版
- 已知问题：下界火焰/烟雾可能无法正确LOD化，建议在下界中关闭遥远的地平线
...
## 告示牌物品展示
### 展示效果
![告示牌物品展示效果](https://i.postimg.cc/dQdZWZMK/gspwpzs.png)
